    ...
    dynamic "master_authorized_networks_config" {
      ...
      content {
        ...
        dynamic "cidr_blocks" {
          ...
          content {
            cidr_block   = master_authorized_networks_config.cidr_blocks.value["cidr_block"]
            display_name = master_authorized_networks_config.cidr_blocks.value["display_name"]
          }
        }
      }
    }
